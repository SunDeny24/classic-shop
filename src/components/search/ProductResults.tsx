    ...
    <div className="flex flex-col md:flex-row w-full bg-white min-h-screen">
      ...
      <aside className="w-full md:w-64 shrink-0 border-b md:border-b-0 md:border-r border-zinc-200 bg-white md:sticky md:top-28 md:h-[calc(100vh-112px)] overflow-y-auto">
        ...
        <div className="flex flex-col md:h-full">
          ...
          <div
            className={`${isFilterExpanded ? "block" : "hidden"} md:block flex flex-col md:h-full`}
          >
            <div className="px-5 py-2 flex-1 md:pb-8">
              ...
              <div className="">
                {/* ------- CATEGORY 섹션 ------- */}
                <div className="mb-6">
                  <h2 className="text-sm md:text-[15px] font-bold text-stone-700 mb-3 ">
                    CATEGORY
                  </h2>
                  {/* 중분류 (Category 2) */}
                ...
                <div className="mb-6 ">
                  <div className="mb-6">
                    <h2 className="text-[15px] font-bold text-stone-700 mb-3 ">
                      PRICE
                    </h2>
                  ...
                  <div className="flex items-center gap-3 px-1">
                    <div className="flex flex-col w-1/2">
                      <span className="text-[11px] text-zinc-500 mb-1">
                        최소
                      </span>
                      <input
                        type="number"
                  ...
                  <div className="mb-6">
                    ...
                    <div className="p-4 bg-zinc-50 border-zinc-900 rounded-r-md">
                      <p className="text-[12px] text-zinc-500 leading-5">
                        ...
                        위주로 먼저 정리해 두었습니다.
                        <br />
                        빈티지나 해외 직구 상품까지 넓게 보고 싶다면 왼쪽으로
                        토글을 꺼주세요!
                      </p>
                    </div>
                  </div>
      ...
      <main className="flex-1 p-5 md:p-10 ">
        {/* 총 갯수 */}
        <div className="flex items-center sticky top-0 bg-white z-10 gap-2 my-2">
        ...
        {isFetchingNextPage ? (
          <div className="flex flex-col items-center gap-2 py-5">
            ...
            <p className="text-[12px] sm:text-sm text-zinc-400 font-light">
              상품을 더 가져오고 있어요
            </p>
          </div>
        ) : (
          ...
          products.length > 0 && (
            <div className="flex flex-col items-center gap-2 py-10">
              <p className="text-zinc-400 text-[12px] sm:text-sm  font-light">
                모든 상품을 확인하셨습니다
              </p>
            </div>
          )
